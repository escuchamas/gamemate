export default function DonationsPage() {
  return (
    <div className="max-w-2xl mx-auto flex flex-col gap-8">
      <div>
        <h1 className="text-2xl font-bold text-white">Apoya GameMate</h1>
      ...
      <div className="rounded-xl bg-[var(--card)] border border-[var(--card-border)] p-6 flex flex-col gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-white">Donación puntual con PayPal</p>
      ...
      <div className="rounded-xl bg-[var(--card)] border border-[var(--card-border)] p-6">
        <h2 className="font-semibold text-white mb-3">¿En qué se usa el dinero?</h2>
      ...
      <p className="text-center text-sm text-[var(--muted-foreground)]">
        ...
        <a href="/sponsorship" className="text-orange-400 hover:underline">
          Mira las opciones de patrocinio
        </a>
      </p>
    </div>
  );
